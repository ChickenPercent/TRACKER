              ...
              {filtered.length === 0 ? (
                games.length === 0 ? (
                  <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', textAlign: 'center', padding: '64px 24px', maxWidth: 420, margin: '0 auto' }}>
                    ...
                    <h2 style={{ fontFamily: "var(--font-body)", fontSize: 22, fontWeight: 800, margin: '0 0 8px' }}>Start your collection</h2>
                    ...
                    <button
                      ...
                      style={{ fontFamily: "var(--font-body)", fontSize: 14, fontWeight: 700, background: 'var(--accent)', color: '#fff', border: 'none', borderRadius: 'var(--radius-sm)', padding: '12px 24px', cursor: 'pointer', display: 'inline-flex', alignItems: 'center', gap: 8, boxShadow: '0 4px 18px color-mix(in srgb, var(--accent) 40%, transparent)' }}
                    >
